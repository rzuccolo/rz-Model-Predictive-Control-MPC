    ...
    if (sdata.size() > 2 && sdata[0] == '4' && sdata[1] == '2') {
      ...
      if (s != "") {
        ...
        if (event == "telemetry") {
          ...
          // Transform the points to vehicle CS
          ...
          */
          ...
          // Fits 3rd-order polynomial
          auto coeffs = polyfit(ptsx_car, ptsy_car, 3);
          
          // Calculates the cross track error
          // Points were transformed to vehicle coordinates, so x & y equal 0.
          double cte = polyeval(coeffs, 0);
          
          // Calculate the orientation error
          // Derivative of the polyfit goes in atan()
          // x = 0 in vehicle coordinates, the higher orders are zero
